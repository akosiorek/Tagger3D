...
\section{Bow of Words}
	...
	In natural language processing BoW is used to infer semantic meaning of documents \rednote{pub}. If we could translate an image into a text document we might be able to employ similar methods. A question arises: How does one make a text document from an image?
	...
	\end{figure}
		...
		\rednote{describe fundamentals of keypoint detection in greater detail}
